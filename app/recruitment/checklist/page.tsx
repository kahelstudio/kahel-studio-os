    ...
    <div className="max-w-[1000px] p-12 pt-9">
      ...
      <div className="mt-6 overflow-hidden rounded-card border border-[var(--color-border)] bg-[var(--color-surface)]">
        {OFFBOARDING_CHECKLIST.map((c) => (
          <div
            key={c.label}
            className="flex items-center gap-3 border-b border-[var(--color-ink-100)] px-5 py-3.5 text-sm last:border-b-0"
          >
            <span className="h-[22px] w-[22px] shrink-0 rounded-[6px] border-[1.5px] border-[var(--color-ink-300)]" />
