...
import { PASSWORD_MIN_LENGTH, PASSWORD_REQUIREMENTS_MESSAGE, passwordMeetsPolicy } from "@/lib/password-policy";
...
export default function ResetPasswordPage() {
  ...
  async function resetPassword(event: FormEvent<HTMLFormElement>) {
    ...
    if (!passwordMeetsPolicy(password)) return setError(PASSWORD_REQUIREMENTS_MESSAGE);
