      ...
      <div className="mt-4 overflow-hidden rounded-card border border-[var(--color-border)] bg-[var(--color-surface)]">
        ...
        {rows.map((r) => {
          ...
          return (
            <div
              key={r.period}
              className="grid h-14 grid-cols-[1fr_1fr_1fr_1fr_0.8fr_1fr_1.2fr] items-center border-b border-[var(--color-ink-100)] px-5 text-sm last:border-b-0"
            >
              ...
              <div className="text-xs text-[var(--color-ink-700)]">{r.due}</div>
              <div>
                <span
