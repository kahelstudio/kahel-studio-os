...
export default function CrmAccountsPage() {
  ...
  return (
    <div className="p-10 pt-8">
      ...
      <div className="mb-4 flex items-center gap-3 rounded-card bg-[var(--color-ink-100)] px-4 py-3">
      ...
      <div className="overflow-hidden rounded-card border border-[var(--color-border)] bg-[var(--color-surface)]">
        <div className="grid h-11 grid-cols-[2fr_1.4fr_0.9fr_1.1fr_1fr] items-center bg-[var(--color-canvas)] px-[18px] text-xs font-semibold uppercase tracking-[0.03em] text-[var(--color-text-secondary)]">
          <div>Account</div>
          <div>Mobile</div>
          <div>Type</div>
        ...
        {ACCOUNTS.map((a) => {
          ...
          return (
            <Link
              ...
              className="grid h-14 grid-cols-[2fr_1.4fr_0.9fr_1.1fr_1fr] items-center border-b border-[var(--color-ink-100)] px-[18px] text-sm last:border-b-0 hover:bg-[var(--color-canvas)]"
            >
              ...
              <div className="text-[13px] text-[var(--color-ink-500)]">{a.phone}</div>
              <div>
                <span
              ...
              <div className="text-[var(--color-ink-600)]">{a.last}</div>
