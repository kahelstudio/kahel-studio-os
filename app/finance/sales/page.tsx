    ...
    <div className="max-w-[1200px] p-12 pt-9">
      ...
      <div className="mt-5 overflow-hidden rounded-card border border-[var(--color-border)] bg-[var(--color-surface)]">
        ...
        {FINANCE_SALES.map((r) => (
          <div
            key={r.ref}
            className="grid h-[54px] grid-cols-[1.1fr_1.8fr_1fr_1fr_1fr] items-center border-b border-[var(--color-ink-100)] px-5 text-sm last:border-b-0 hover:bg-[var(--color-canvas)]"
          >
