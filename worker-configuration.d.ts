/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=staging --env-interface=CloudflareEnv` (hash: 5a1c107423bf0bd683757be6b7c57c1f)
...
interface __BaseEnv_CloudflareEnv {
	...
	APP_ENV: "staging";
	MEDIA_INFRASTRUCTURE_ENABLED: "true";
	CLIENT_MEDIA_BUCKET_NAME: "kahel-client-media-staging";
	TURNSTILE_SITE_KEY: "0x4AAAAAAEDc-FdHAx_QAhyZ";
	NEXTJS_ENV: string;
	SUPABASE_URL: string;
