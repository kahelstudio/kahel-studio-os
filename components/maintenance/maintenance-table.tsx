      ...
      <div className="mt-6 overflow-hidden rounded-card border border-[var(--color-border)] bg-[var(--color-surface)]">
        ...
        {rows.map((m) => (
          ...
          >
            ...
            <div>
              <div className="text-[var(--color-text-primary)]">{m.mtype}</div>
              <div className="text-[11px] text-[var(--color-teal-800)]">↻ {m.recur}</div>
            </div>
            <div className="text-[var(--color-text-primary)]">{m.who}</div>
            <div className="text-xs text-[var(--color-text-primary)]">{m.next}</div>
            <div>
              <div className="text-xs text-[var(--color-text-primary)]">{m.est}</div>
