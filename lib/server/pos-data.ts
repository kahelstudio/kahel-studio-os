...
export async function getProducts(): Promise<ProductRow[]> {
  try {
    ...
    console.error("getProducts: table not available", (error as Error).message);
    return [];
  }
}
...
export async function getPosCatalogs(): Promise<CatalogRow[]> {
  try {
    ...
    console.error("getPosCatalogs: table not available", (error as Error).message);
    return [];
  }
}
...
export async function getRecentSales(): Promise<RecentSaleRow[]> {
  try {
    ...
    console.error("getRecentSales: table not available", (error as Error).message);
    return [];
  }
}
