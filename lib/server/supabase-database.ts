...
type EquipmentRow = { id: string; id_tag: string; serial: string | null; name: string; category: string; status: string; note: string | null; location: string | null; created_at: string; updated_at: string };
