/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.media.jsonc --env=staging --env-interface=MediaProcessorEnv worker-media-configuration.d.ts` (hash: 801e11f8a2cfb745e8158c0448f38d78)
// Runtime types generated with workerd@1.20260730.1 2026-08-01 nodejs_compat
interface __BaseEnv_MediaProcessorEnv {
	PUBLIC_MEDIA: R2Bucket;
	CLIENT_MEDIA: R2Bucket;
	IMAGES: ImagesBinding;
	APP_ENV: "staging";
	WATERMARK_R2_KEY: "system/kahelstudio-watermark.svg";
	NEXTJS_ENV: string;
	SUPABASE_URL: string;
	...
	CUSTOMER_AUTH_CALLBACK_URL: string;
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/media-processor");
	}
	interface Env extends __BaseEnv_MediaProcessorEnv {}
}
interface MediaProcessorEnv extends __BaseEnv_MediaProcessorEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "WATERMARK_R2_KEY" | "NEXTJS_ENV" | "SUPABASE_URL" | "SUPABASE_PUBLISHABLE_KEY" | "SUPABASE_SECRET_KEY" | "KAHEL_STAFF_EMAIL" | "KAHEL_STAFF_EMAILS" | "AUTH_REDIRECT_URL" | "CUSTOMER_AUTH_CALLBACK_URL" | "PUBLIC_SITE_URL" | "BOOKING_EMAIL_FROM" | "BOOKING_EMAIL_REPLY_TO" | "KAHEL_AUTH_DISABLED" | "TURNSTILE_SECRET" | "GOOGLE_AUTH_ENABLED" | "PAYMONGO_SECRET_KEY">> {}
}
