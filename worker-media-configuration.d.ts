/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.media.jsonc --env=staging --env-interface=MediaProcessorEnv worker-media-configuration.d.ts` (hash: 66edc0dcc5c5feb930c61aef258681f2)
...
interface __BaseEnv_MediaProcessorEnv {
	...
	GALLERY_EMAIL_FROM: string;
	GALLERY_EMAIL_REPLY_TO: string;
