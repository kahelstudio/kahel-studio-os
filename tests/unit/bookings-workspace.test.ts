...
// Fixture dates are relative to "now" (with a same-day margin covering the
// UTC-to-Manila skew) so tests that check upcoming/awaiting-payment status
// stay correct regardless of when they run, instead of expiring like a
// hardcoded calendar date would.
function futureDate(daysFromNow: number) {
  const date = new Date();
  date.setUTCDate(date.getUTCDate() + daysFromNow);
  return date.toISOString().slice(0, 10);
}
const [date1, date2, date3] = [futureDate(1), futureDate(3), futureDate(6)];

const rows: BookingWorkspaceRow[] = [
  { id: "1", reference: "KS-2026-0001", clientId: "c1", clientName: "Ana Cruz", clientEmail: "ana@example.com", clientPhone: "+639171111111", clientExternalRef: "KAHEL-1", serviceType: "Portrait Session", serviceId: null, serviceDate: date1, serviceTime: "09:00", location: "Studio A", status: "inquiry", paymentStatus: "unpaid", totalAmountPhp: 5000, paidAmountPhp: 0, refundedAmountPhp: 0, completedAt: null, createdAt: "2026-08-16T01:00:00Z", updatedAt: "2026-08-16T01:00:00Z", kind: "standard", attendance: "expected", projectReference: null, projectStatus: null, invoiceReference: null, invoiceStatus: null, invoicePaidAmountPhp: null, invoiceTotalAmountPhp: null, paymongoPaymentMethod: null, paymongoPaymentDescription: null, paymongoPaidAt: null, paymongoAvailableAt: null, paymongoCheckoutSessionId: null, paymongoCheckoutUrl: null },
  { id: "2", reference: "KS-2026-0002", clientId: "c2", clientName: "Ben Lim", clientEmail: "ben@example.com", clientPhone: "+639181111111", clientExternalRef: "KAHEL-2", serviceType: "Wedding Coverage", serviceId: null, serviceDate: date2, serviceTime: "12:00", location: "Fairmont Makati", status: "quoted", paymentStatus: "pending", totalAmountPhp: 185000, paidAmountPhp: 0, refundedAmountPhp: 0, completedAt: null, createdAt: "2026-08-15T00:30:00Z", updatedAt: "2026-08-15T00:30:00Z", kind: "standard", attendance: "expected", projectReference: null, projectStatus: null, invoiceReference: null, invoiceStatus: null, invoicePaidAmountPhp: null, invoiceTotalAmountPhp: null, paymongoPaymentMethod: null, paymongoPaymentDescription: null, paymongoPaidAt: null, paymongoAvailableAt: null, paymongoCheckoutSessionId: null, paymongoCheckoutUrl: null },
  { id: "3", reference: "KS-2026-0003", clientId: "c3", clientName: "Cara Tan", clientEmail: "cara@example.com", clientPhone: "+639191111111", clientExternalRef: "KAHEL-3", serviceType: "Rental Gear", serviceId: null, serviceDate: date3, serviceTime: "15:00", location: "Pickup", status: "confirmed", paymentStatus: "partially_paid", totalAmountPhp: 12000, paidAmountPhp: 6000, refundedAmountPhp: 0, completedAt: null, createdAt: "2026-08-14T00:30:00Z", updatedAt: "2026-08-14T00:30:00Z", kind: "standard", attendance: "expected", projectReference: "KS-PROJ-1", projectStatus: "planned", invoiceReference: "INV-1", invoiceStatus: "issued", invoicePaidAmountPhp: 6000, invoiceTotalAmountPhp: 12000, paymongoPaymentMethod: "gcash", paymongoPaymentDescription: null, paymongoPaidAt: null, paymongoAvailableAt: null, paymongoCheckoutSessionId: null, paymongoCheckoutUrl: null },
  { id: "4", reference: "KS-2026-0004", clientId: "c4", clientName: "Dev Note", clientEmail: "dev@example.com", clientPhone: null, clientExternalRef: null, serviceType: "Internal Review", serviceId: null, serviceDate: date1, serviceTime: "17:00", location: "Office", status: "confirmed", paymentStatus: "paid", totalAmountPhp: 0, paidAmountPhp: 0, refundedAmountPhp: 0, completedAt: null, createdAt: "2026-08-16T02:00:00Z", updatedAt: "2026-08-16T02:00:00Z", kind: "internal", attendance: "expected", projectReference: null, projectStatus: null, invoiceReference: null, invoiceStatus: null, invoicePaidAmountPhp: null, invoiceTotalAmountPhp: null, paymongoPaymentMethod: null, paymongoPaymentDescription: null, paymongoPaidAt: null, paymongoAvailableAt: null, paymongoCheckoutSessionId: null, paymongoCheckoutUrl: null },
];
