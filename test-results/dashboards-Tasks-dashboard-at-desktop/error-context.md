...
- Name: dashboards.spec.ts >> Tasks dashboard at desktop
- Location: tests/visual/dashboards.spec.ts:18:7
...
Locator: getByRole('heading', { name: 'Studio operations' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Studio operations' })
...
- main:
  - complementary:
    - img "Portrait photographed at Kahel Studio"
    - img "Kahel Studio"
    - paragraph: Every shoot, booking, and delivery in one place.
    - paragraph: Kahel Studio Operations
